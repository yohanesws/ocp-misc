try {
    timeout(time:60 , unit: 'MINUTES'){
        def projectDev="retina-testing"
        def projectTesting="retina-staging"
        ...
        node ("maven"){
            stage ("promote to Testing"){
                ...
                timeout (time:10, unit: 'MINUTES'){
                    env.APP= input message : "promote to Staging", ok:"Promote",
